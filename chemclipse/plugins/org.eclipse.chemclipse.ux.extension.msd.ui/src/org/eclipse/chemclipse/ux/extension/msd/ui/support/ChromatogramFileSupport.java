...
public class ChromatogramFileSupport {
	...
	public static boolean saveChromatogram(IChromatogramMSD chromatogram) throws NoConverterAvailableException {
		...
		IChromatogramConverterSupport converterSupport = ChromatogramConverterMSD.getInstance().getChromatogramConverterSupport();
		/*
	 ...
	 * @param supplier
	 */
	public static void writeFile(final File file, final IChromatogramMSD chromatogram, final ISupplier supplier) {
